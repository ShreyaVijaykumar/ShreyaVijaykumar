...
I’m all about **blending AI with real-world impact** — from **medical imaging and federated learning** to **AI-driven judiciary systems** and **system-level optimization**.  
I enjoy building systems that are **interpretable, scalable, and deployment-aware** across ML, backend, and low-level environments.
...
- **IEEE CommBattle Ideathon Winner (2024)** — Built an AI-driven judiciary prototype (*Public Pulse*)  
- **C-DAC Intern** — Kernel optimization for **BOSS OS** (latency & CPU scheduling improvements)  
- **International Delegate (Malaysia)** — Technology & policy exposure through global exchange  
...
![](https://komarev.com/ghpvc/?username=ShreyaVijaykumar&color=blueviolet)
